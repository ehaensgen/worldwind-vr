...
//        System.out.println(totalForwardInput + " "  + totalSideInput + " " + cameraTranslationSpeed + " " + getScaleValueElevation(deviceAttributes, actionAttributes));
//        System.out.println(forwardInput + " " + sideInput + " " + actionAttributes.getMouseActions());
//        double[] range = actionAttributes.getValues();
//        System.out.println("  * " + range[0] + " " + range[1] + " " + deviceAttributes.getSensitivity());
