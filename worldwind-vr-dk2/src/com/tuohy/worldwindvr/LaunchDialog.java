	...
	public LaunchDialog(){
		...
		launchButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				//TODO: default behavior should be to take the 1920x1080 screen that has id >0
				new WorldWindVR(hiResImagerySelector.isSelected(), precacheModeSelector.isSelected(), gs[1].getDefaultConfiguration());
			}
