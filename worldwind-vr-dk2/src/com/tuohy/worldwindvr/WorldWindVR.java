...
public class WorldWindVR extends Frame{
	...
	public WorldWindVR(boolean useHighResImagery, boolean startInPrecacheMode, GraphicsConfiguration graphicsConfiguration){
		super("WorldWindVR",graphicsConfiguration);
